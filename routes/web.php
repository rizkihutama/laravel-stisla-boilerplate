...
Route::get('/', fn () => redirect()->route('dashboard-general'));

// Dashboard
Route::prefix('dashboard')->group(function () {
    Route::get('general-dashboard', fn () => view('pages.dashboard.general-dashboard'))->name('dashboard-general');

    Route::get('ecommerce-dashboard', fn () => view('pages.dashboard.ecommerce-dashboard'))->name('dashboard-ecommerce');
});

// Layout
Route::prefix('layout')->group(function () {
    Route::get('default-layout', fn () => view('pages.layout.default-layout'))->name('layout-default');

    Route::get('transparent-sidebar', fn () => view('pages.layout.transparent-sidebar'))->name('layout-transparent-sidebar');

    Route::get('top-navigation', fn () => view('pages.layout.top-navigation'))->name('layout-top-navigation');
});

// Blank Page
Route::get('blank-page', fn () => view('pages.blank-page'))->name('blank-page');
