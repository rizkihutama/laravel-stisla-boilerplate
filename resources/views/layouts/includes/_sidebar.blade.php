...
<ul class="sidebar-menu">
    ...
    <li class="nav-item dropdown {{ request()->segment(1) === 'dashboard' ? 'active' : '' }}">
        ...
        <ul class="dropdown-menu">
            <li class='{{ Request::is('dashboard/general-dashboard') ? 'active' : '' }}'>
                <a class="nav-link" href="{{ route('dashboard-general') }}">General Dashboard</a>
            </li>
            <li class="{{ Request::is('dashboard/ecommerce-dashboard') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('dashboard-ecommerce') }}">Ecommerce Dashboard</a>
            </li>
        </ul>
    </li>
    <li class="menu-header">Starter</li>
    <li class="nav-item dropdown {{ request()->segment(1) === 'layout' ? 'active' : '' }}">
        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
            <i class="fas fa-columns"></i><span>Layout</span>
        </a>
        <ul class="dropdown-menu">
            <li class="{{ Request::is('layout/default-layout') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('layout-default') }}">Default Layout</a>
            </li>
            <li class="{{ Request::is('layout/transparent-sidebar') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('layout-transparent-sidebar') }}">Transparent Sidebar</a>
            </li>
            <li class="{{ Request::is('layout/top-navigation') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('layout-top-navigation') }}">Top Navigation</a>
            </li>
        </ul>
    </li>
    ...
    <li class="nav-item dropdown {{ request()->segment(1) === 'bootstrap' ? 'active' : '' }}">
    ...
    <li class="nav-item dropdown {{ request()->segment(1) === 'components' ? 'active' : '' }}">
    ...
    <li class="nav-item dropdown {{ request()->segment(1) === 'modules' ? 'active' : '' }}">
    ...
    <li class="nav-item dropdown {{ request()->segment(1) === 'auth' ? 'active' : '' }}">
    ...
    <li class="nav-item dropdown {{ request()->segment(1) === 'error' ? 'active' : '' }}">
    ...
    <li class="nav-item dropdown {{ request()->segment(1) === 'features' ? 'active' : '' }}">
    ...
    <li class="nav-item dropdown {{ request()->segment(1) === 'utilities' ? 'active' : '' }}">
